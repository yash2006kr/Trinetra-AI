"""Alert rules for smart_city_security."""
...
def build_event_alert(camera_id: str, title: str, message: str, event_id: str | None = None, priority: AlertPriority = AlertPriority.MEDIUM) -> Alert:
    return Alert(module="smart_city_security", camera_id=camera_id, title=title, message=message, event_id=event_id, priority=priority)


class SmartCitySecurityAlertRules:
