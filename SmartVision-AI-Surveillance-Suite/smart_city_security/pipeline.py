"""Pipeline entrypoint for smart_city_security."""
...
class SmartCitySecurityPipeline(DomainPipeline):
    def __init__(self, config_path: str | Path | None = None) -> None:
        super().__init__("smart_city_security", config_path or Path(__file__).with_name("config.yaml"))
