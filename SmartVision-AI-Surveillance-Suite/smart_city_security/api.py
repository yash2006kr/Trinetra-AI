"""FastAPI routes for the Smart City Security module."""
...
MODULE_NAME = "smart_city_security"
CONFIG_PATH = Path(__file__).with_name("config.yaml")
router = APIRouter(prefix="/api/modules/smart_city_security", tags=["Smart City Security"])
