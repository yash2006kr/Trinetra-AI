"""Pipeline entrypoint for retail_analytics."""
...
class RetailAnalyticsPipeline(DomainPipeline):
    def __init__(self, config_path: str | Path | None = None) -> None:
        super().__init__("retail_analytics", config_path or Path(__file__).with_name("config.yaml"))
