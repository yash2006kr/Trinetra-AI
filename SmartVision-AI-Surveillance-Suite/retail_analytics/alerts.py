"""Alert rules for retail_analytics."""
...
def build_event_alert(camera_id: str, title: str, message: str, event_id: str | None = None, priority: AlertPriority = AlertPriority.MEDIUM) -> Alert:
    return Alert(module="retail_analytics", camera_id=camera_id, title=title, message=message, event_id=event_id, priority=priority)


class RetailAnalyticsAlertRules:
