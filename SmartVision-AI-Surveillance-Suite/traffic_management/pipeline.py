"""Pipeline entrypoint for traffic_management."""
...
class TrafficManagementPipeline(DomainPipeline):
    def __init__(self, config_path: str | Path | None = None) -> None:
        super().__init__("traffic_management", config_path or Path(__file__).with_name("config.yaml"))
