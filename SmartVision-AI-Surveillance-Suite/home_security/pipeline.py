"""Pipeline entrypoint for home_security."""
...
class HomeSecurityPipeline(DomainPipeline):
    def __init__(self, config_path: str | Path | None = None) -> None:
        super().__init__("home_security", config_path or Path(__file__).with_name("config.yaml"))
