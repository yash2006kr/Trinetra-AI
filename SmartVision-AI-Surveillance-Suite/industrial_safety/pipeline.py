"""Pipeline entrypoint for industrial_safety."""
...
class IndustrialSafetyPipeline(DomainPipeline):
    def __init__(self, config_path: str | Path | None = None) -> None:
        super().__init__("industrial_safety", config_path or Path(__file__).with_name("config.yaml"))
