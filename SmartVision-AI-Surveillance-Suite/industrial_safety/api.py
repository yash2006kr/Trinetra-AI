"""FastAPI routes for the Industrial Safety module."""
...
MODULE_NAME = "industrial_safety"
CONFIG_PATH = Path(__file__).with_name("config.yaml")
router = APIRouter(prefix="/api/modules/industrial_safety", tags=["Industrial Safety"])
