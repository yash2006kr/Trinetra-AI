"""Pipeline entrypoint for smart_parking."""
...
class SmartParkingPipeline(DomainPipeline):
    def __init__(self, config_path: str | Path | None = None) -> None:
        super().__init__("smart_parking", config_path or Path(__file__).with_name("config.yaml"))
