"""Pipeline entrypoint for wildlife_monitoring."""
...
class WildlifeMonitoringPipeline(DomainPipeline):
    def __init__(self, config_path: str | Path | None = None) -> None:
        super().__init__("wildlife_monitoring", config_path or Path(__file__).with_name("config.yaml"))
