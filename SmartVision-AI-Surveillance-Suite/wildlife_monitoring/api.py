"""FastAPI routes for the Wildlife Monitoring module."""
...
MODULE_NAME = "wildlife_monitoring"
CONFIG_PATH = Path(__file__).with_name("config.yaml")
router = APIRouter(prefix="/api/modules/wildlife_monitoring", tags=["Wildlife Monitoring"])
