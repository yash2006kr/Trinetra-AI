"""Pipeline entrypoint for railway_surveillance."""
...
class RailwaySurveillancePipeline(DomainPipeline):
    def __init__(self, config_path: str | Path | None = None) -> None:
        super().__init__("railway_surveillance", config_path or Path(__file__).with_name("config.yaml"))
