"""FastAPI routes for the Railway Surveillance module."""
...
MODULE_NAME = "railway_surveillance"
CONFIG_PATH = Path(__file__).with_name("config.yaml")
router = APIRouter(prefix="/api/modules/railway_surveillance", tags=["Railway Surveillance"])
