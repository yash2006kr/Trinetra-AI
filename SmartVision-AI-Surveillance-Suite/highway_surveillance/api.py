"""FastAPI routes for the Highway Surveillance module."""
...
MODULE_NAME = "highway_surveillance"
CONFIG_PATH = Path(__file__).with_name("config.yaml")
router = APIRouter(prefix="/api/modules/highway_surveillance", tags=["Highway Surveillance"])
